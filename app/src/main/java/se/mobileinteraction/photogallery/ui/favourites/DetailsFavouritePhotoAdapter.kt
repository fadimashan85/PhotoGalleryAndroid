...
class DetailsFavouritePhotoAdapter(val onChecked: (Boolean, UnsplashPhoto) -> Unit, val onClick: (View, UnsplashPhoto) -> Unit, val isFavourited: (String) -> Boolean) :
    RecyclerView.Adapter<DetailsFavouritePhotoAdapter.DetailsPhotoViewHolder>() {
